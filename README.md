...
This is a ground-up rebuild of [the original Boggle Vision](https://github.com/trevbook/boggle-vision) (2023), which used a Python/FastAPI backend with OpenCV + a custom PyTorch CNN, a React/Redux frontend, and GCP hosting. This new version uses a Next.js frontend with shadcn/ui, a Python CV pipeline (Ultralytics YOLO + OpenCV + ONNX Runtime) deployed as a containerized AWS Lambda, and a TypeScript board solver — all wired together with SST v3.
