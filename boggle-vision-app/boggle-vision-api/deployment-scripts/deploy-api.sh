...
sudo docker pull us-central1-docker.pkg.dev/boggle-vision/boggle-vision-webapp/boggle-vision-api:latest

# Stop and remove the current running container
echo "Stopping and removing current container..."
sudo docker stop boggle-vision-api-container || true
sudo docker rm boggle-vision-api-container || true
